...
if(window.Zepto){window.Zepto.fn.waypoint=createExtension(window.Zepto)}}());;(function(){'use strict';if(navigator.userAgent.match(/IEMobile\/10\.0/)){var msViewportStyle=document.createElement('style')
msViewportStyle.appendChild(document.createTextNode('@-ms-viewport{width:auto!important}'))
document.querySelector('head').appendChild(msViewportStyle)}})();if(window.location.protocol!="https:"&&window.location.hostname.indexOf('localhost')==-1)
window.location.href="https:"+window.location.href.substring(window.location.protocol.length);if(window.location.hostname.indexOf('localhost')==-1){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');ga('create','UA-68571424-1','auto');ga('set','anonymizeIp',true);ga('set','allowAdFeatures',false);ga('send','pageview',window.location.pathname);}
else
{function ga(){}}/*!
 ...
 */
+function(a){"use strict";function b(b){return b.is('[type="checkbox"]')?b.prop("checked"):b.is('[type="radio"]')?!!a('[name="'+b.attr("name")+'"]:checked').length:b.is("select[multiple]")?(b.val()||[]).length:b.val()}function c(b){return this.each(function(){var c=a(this),e=a.extend({},d.DEFAULTS,c.data(),"object"==typeof b&&b),f=c.data("bs.validator");(f||"destroy"!=b)&&(f||c.data("bs.validator",f=new d(this,e)),"string"==typeof b&&f[b]())})}var d=function(c,e){this.options=e,this.validators=a.extend({},d.VALIDATORS,e.custom),this.$element=a(c),this.$btn=a('button[type="submit"], input[type="submit"]').filter('[form="'+this.$element.attr("id")+'"]').add(this.$element.find('input[type="submit"], button[type="submit"]')),this.update(),this.$element.on("input.bs.validator change.bs.validator focusout.bs.validator",a.proxy(this.onInput,this)),this.$element.on("submit.bs.validator",a.proxy(this.onSubmit,this)),this.$element.on("reset.bs.validator",a.proxy(this.reset,this)),this.$element.find("[data-match]").each(function(){var c=a(this),d=c.attr("data-match");a(d).on("input.bs.validator",function(){b(c)&&c.trigger("input.bs.validator")})}),this.$inputs.filter(function(){return b(a(this))&&!a(this).closest(".has-error").length}).trigger("focusout"),this.$element.attr("novalidate",!0)};d.VERSION="0.11.9",d.INPUT_SELECTOR=':input:not([type="hidden"], [type="submit"], [type="reset"], button)',d.FOCUS_OFFSET=20,d.DEFAULTS={delay:500,html:!1,disable:!0,focus:!0,custom:{},errors:{match:"Does not match",minlength:"Not long enough"},feedback:{success:"glyphicon-ok",error:"glyphicon-remove"}},d.VALIDATORS={"native":function(a){var b=a[0];return b.checkValidity?!b.checkValidity()&&!b.validity.valid&&(b.validationMessage||"error!"):void 0},match:function(b){var c=b.attr("data-match");return b.val()!==a(c).val()&&d.DEFAULTS.errors.match},minlength:function(a){var b=a.attr("data-minlength");return a.val().length<b&&d.DEFAULTS.errors.minlength}},d.prototype.update=function(){var b=this;return this.$inputs=this.$element.find(d.INPUT_SELECTOR).add(this.$element.find('[data-validate="true"]')).not(this.$element.find('[data-validate="false"]').each(function(){b.clearErrors(a(this))})),this.toggleSubmit(),this},d.prototype.onInput=function(b){var c=this,d=a(b.target),e="focusout"!==b.type;this.$inputs.is(d)&&this.validateInput(d,e).done(function(){c.toggleSubmit()})},d.prototype.validateInput=function(c,d){var e=(b(c),c.data("bs.validator.errors"));c.is('[type="radio"]')&&(c=this.$element.find('input[name="'+c.attr("name")+'"]'));var f=a.Event("validate.bs.validator",{relatedTarget:c[0]});if(this.$element.trigger(f),!f.isDefaultPrevented()){var g=this;return this.runValidators(c).done(function(b){c.data("bs.validator.errors",b),b.length?d?g.defer(c,g.showErrors):g.showErrors(c):g.clearErrors(c),e&&b.toString()===e.toString()||(f=b.length?a.Event("invalid.bs.validator",{relatedTarget:c[0],detail:b}):a.Event("valid.bs.validator",{relatedTarget:c[0],detail:e}),g.$element.trigger(f)),g.toggleSubmit(),g.$element.trigger(a.Event("validated.bs.validator",{relatedTarget:c[0]}))})}},d.prototype.runValidators=function(c){function d(a){return c.attr("data-"+a+"-error")}function e(){var a=c[0].validity;return a.typeMismatch?c.attr("data-type-error"):a.patternMismatch?c.attr("data-pattern-error"):a.stepMismatch?c.attr("data-step-error"):a.rangeOverflow?c.attr("data-max-error"):a.rangeUnderflow?c.attr("data-min-error"):a.valueMissing?c.attr("data-required-error"):null}function f(){return c.attr("data-error")}function g(a){return d(a)||e()||f()}var h=[],i=a.Deferred();return c.data("bs.validator.deferred")&&c.data("bs.validator.deferred").reject(),c.data("bs.validator.deferred",i),a.each(this.validators,a.proxy(function(a,d){var e=null;!b(c)&&!c.attr("required")||void 0===c.attr("data-"+a)&&"native"!=a||!(e=d.call(this,c))||(e=g(a)||e,!~h.indexOf(e)&&h.push(e))},this)),!h.length&&b(c)&&c.attr("data-remote")?this.defer(c,function(){var d={};d[c.attr("name")]=b(c),a.get(c.attr("data-remote"),d).fail(function(a,b,c){h.push(g("remote")||c)}).always(function(){i.resolve(h)})}):i.resolve(h),i.promise()},d.prototype.validate=function(){var b=this;return a.when(this.$inputs.map(function(){return b.validateInput(a(this),!1)})).then(function(){b.toggleSubmit(),b.focusError()}),this},d.prototype.focusError=function(){if(this.options.focus){var b=this.$element.find(".has-error :input:first");0!==b.length&&(a("html, body").animate({scrollTop:b.offset().top-d.FOCUS_OFFSET},250),b.focus())}},d.prototype.showErrors=function(b){var c=this.options.html?"html":"text",d=b.data("bs.validator.errors"),e=b.closest(".form-group"),f=e.find(".help-block.with-errors"),g=e.find(".form-control-feedback");d.length&&(d=a("<ul/>").addClass("list-unstyled").append(a.map(d,function(b){return a("<li/>")[c](b)})),void 0===f.data("bs.validator.originalContent")&&f.data("bs.validator.originalContent",f.html()),f.empty().append(d),e.addClass("has-error has-danger"),e.hasClass("has-feedback")&&g.removeClass(this.options.feedback.success)&&g.addClass(this.options.feedback.error)&&e.removeClass("has-success"))},d.prototype.clearErrors=function(a){var c=a.closest(".form-group"),d=c.find(".help-block.with-errors"),e=c.find(".form-control-feedback");d.html(d.data("bs.validator.originalContent")),c.removeClass("has-error has-danger has-success"),c.hasClass("has-feedback")&&e.removeClass(this.options.feedback.error)&&e.removeClass(this.options.feedback.success)&&b(a)&&e.addClass(this.options.feedback.success)&&c.addClass("has-success")},d.prototype.hasErrors=function(){function b(){return!!(a(this).data("bs.validator.errors")||[]).length}return!!this.$inputs.filter(b).length},d.prototype.isIncomplete=function(){function c(){var c=b(a(this));return!("string"==typeof c?a.trim(c):c)}return!!this.$inputs.filter("[required]").filter(c).length},d.prototype.onSubmit=function(a){this.validate(),(this.isIncomplete()||this.hasErrors())&&a.preventDefault()},d.prototype.toggleSubmit=function(){this.options.disable&&this.$btn.toggleClass("disabled",this.isIncomplete()||this.hasErrors())},d.prototype.defer=function(b,c){return c=a.proxy(c,this,b),this.options.delay?(window.clearTimeout(b.data("bs.validator.timeout")),void b.data("bs.validator.timeout",window.setTimeout(c,this.options.delay))):c()},d.prototype.reset=function(){return this.$element.find(".form-control-feedback").removeClass(this.options.feedback.error).removeClass(this.options.feedback.success),this.$inputs.removeData(["bs.validator.errors","bs.validator.deferred"]).each(function(){var b=a(this),c=b.data("bs.validator.timeout");window.clearTimeout(c)&&b.removeData("bs.validator.timeout")}),this.$element.find(".help-block.with-errors").each(function(){var b=a(this),c=b.data("bs.validator.originalContent");b.removeData("bs.validator.originalContent").html(c)}),this.$btn.removeClass("disabled"),this.$element.find(".has-error, .has-danger, .has-success").removeClass("has-error has-danger has-success"),this},d.prototype.destroy=function(){return this.reset(),this.$element.removeAttr("novalidate").removeData("bs.validator").off(".bs.validator"),this.$inputs.off(".bs.validator"),this.options=null,this.validators=null,this.$element=null,this.$btn=null,this.$inputs=null,this};var e=a.fn.validator;a.fn.validator=c,a.fn.validator.Constructor=d,a.fn.validator.noConflict=function(){return a.fn.validator=e,this},a(window).on("load",function(){a('form[data-toggle="validator"]').each(function(){var b=a(this);c.call(b,b.data())})})}(jQuery);$(function(){if($("body.classic").length){$(".sidebar__btn").on('click',function(){$(".sidebar__btn_open").toggleClass("show hidden");$(".sidebar__menu").toggleClass("sidebar__menu_hidden");return false;});}});$(function(){if($("body.classic").length){$('.navbar-collapse li > a').on('click',function(){if($('.navbar-collapse').attr("aria-expanded")){$('.navbar-collapse.in').collapse('hide');}});}});$(function(){setTimeout(function(){if($("body.classic").length){$(function(){$("body").waypoint(function(){$(".navbar").toggleClass("navbar__initial");return false;},{offset:"-20px"});});$(function(){$("body").waypoint(function(){$(".sidebar__btn").toggleClass("sidebar__btn_alt");return false;},{offset:"-100%"});});$(function(){$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,'')==this.pathname.replace(/^\//,'')&&location.hostname==this.hostname){var target=$(this.hash);target=target.length?target:$('[name='+this.hash.slice(1)+']');if(target.length){$('html, body').animate({scrollTop:target.offset().top},1000);return false;}}});});}},100);});var client={sync_controls_to_state:function(){var is_clean=true;if(server==null||server.user_state==null){return;}
$('#txtQuery').val(server.user_state.search_query);is_clean=is_clean&&!server.user_state.search_query;a_selector="a[frequency_min='"+server.user_state.frequency_min+"']";a_selector+="[frequency_max='"+server.user_state.frequency_max+"']";a_control=$('#optsFrequency').find(a_selector);$('#lblFrequency').text(a_control.text());is_clean=is_clean&&a_control[0].hasAttribute('default');a_selector="a[risk='"+server.user_state.risk+"']";a_control=$('#optsRisk').find(a_selector);$('#lblRisk').text(a_control.text());is_clean=is_clean&&a_control[0].hasAttribute('default');a_selector="a[topic='"+server.user_state.topic_id+"']";a_control=$('#optsTopic').find(a_selector);$('#lblTopic').text(a_control.text());is_clean=is_clean&&a_control[0].hasAttribute('default');$('#btnClear').css('display',is_clean?'none':'');},sync_rare_threshold_to_state:function(){$('#rareThreshold').val(server.user_state.frequency_max*100.0);},sync_topics_to_state:function(target){topic=$(target).find('img');if(topic&&topic.length>0){server.user_state.id_filter=topic[0].getAttribute('data-ids');server.user_state.page=1;server.user_state.page_size=100;}},getDocHeight:function(){var D=document;return Math.max(D.body.scrollHeight,D.documentElement.scrollHeight,D.body.offsetHeight,D.documentElement.offsetHeight,D.body.clientHeight,D.documentElement.clientHeight);}};var server={user_state:null,endpointURL:null,loading:false,endContent:false,counter:0,getPage:function(){if(this.user_state==null){return;}
var self=this;var seq=++this.counter;this.loading=true;$('#divLoader').css('display','');if(window.location.href.indexOf("search")>-1){client.sync_controls_to_state();}
if(window.location.href.indexOf("rare")>-1){client.sync_rare_threshold_to_state();}
if($('.topics-loading').length>0){target=$('.topics-loading');target.removeClass('topics-loading')
client.sync_topics_to_state(target);}
if(server.user_state.page==1)$('#mainContent').html('');$.ajax({method:'POST',url:this.endpointURL,data:{csrfmiddlewaretoken:$('[name="csrfmiddlewaretoken"]').val(),user_state:JSON.stringify(this.user_state)}}).done(function(data,text_status,jq_xhr){if(seq===self.counter){jq_data=$(data);if(jq_data.filter('title').length){window.location=window.location.href.replace(window.location.pathname,'');return;}
server.endContent=jq_data.filter('#divEnd').length>0;if(server.user_state.page==1)$('#mainContent').html(data);else{$('#mainContent').append(data);ga('send','event','browse','scroll-page',server.user_state.page,0);}
setup_handlers();server.loading=false;$('#divLoader').css('display','none');if(window.location.href.indexOf("search")>-1){nux_tour();}}}).fail(function(data){$('#mainContent').html(data.responseText);server.loading=false;$('#divLoader').css('display','none');});}};$(function(){if($("#optsFrequency").length>0){$('#optsFrequency').find('a').click(function(event){server.user_state.frequency_min=$(event.target).attr('frequency_min');server.user_state.frequency_max=$(event.target).attr('frequency_max');server.user_state.page=1;server.getPage();ga('send','event','browse','frequency-max','',0);});}
if($("#optsRisk").length>0){$('#optsRisk').find('a').click(function(event){server.user_state.risk=$(event.target).attr('risk');server.user_state.page=1;server.getPage();ga('send','event','browse','risk','',0);});}
if($("#optsTopic").length>0){$('#optsTopic').find('a').click(function(event){server.user_state.topic_id=$(event.target).attr('topic');server.user_state.page=1;server.getPage();ga('send','event','browse','topic','',0);});}
if($("#btnSearch").length>0&&$('#txtQuery').length>0){$('#btnSearch').click(function(event){search(event);});$('#txtQuery').keyup(function(event){if(event.keyCode==13)search(event);});}
if($("#rareSubmit").length>0&&$("#rareThreshold").length>0){$('#rareSubmit').click(function(event){server.user_state.frequency_max=$('#rareThreshold').val()/100.0;server.user_state.page=1;server.getPage();});$('#rareThreshold').keyup(function(event){if(event.keyCode==13){server.user_state.frequency_max=$(event.target).val()/100.0;server.user_state.page=1;server.getPage();}});}
function search(event){$('.typeahead').typeahead('close');server.user_state.search_query=$('#txtQuery').val().trim();server.user_state.page=1;server.getPage();ga('send','event','browse','term','',0);};if($("#btnClear").length>0){$('#btnClear').click(function(){server.user_state.search_query='';server.user_state.frequency_min=0;server.user_state.frequency_max=1;server.user_state.risk='';server.user_state.topic_id='';server.user_state.page=1;server.getPage();});}
if($('#carousel-custom').length>0){$('#carousel-custom').on('slide.bs.carousel',function(event){client.sync_topics_to_state($(event.relatedTarget));server.getPage();});}
$(window).scroll(function(){if($(window).scrollTop()+$(window).height()>client.getDocHeight()-50&&server.user_state&&!server.loading&&!server.endContent){server.user_state.page+=1;server.getPage();}});server.getPage();});function toggle_fav(fav){if(fav.hasAttribute('active')){fav.removeAttribute('active');}
else{fav.setAttribute('active','');}
ga('send','event','favorite','toggle',fav.hasAttribute('active'),0);};function get_or_add_comments(t){toadd=''
var genodiv=$(t).closest("div.ggrp")
if(t.tagName.toLowerCase()=='button'){toadd=genodiv.find("input[type='text']").val();}
genodiv.find("input[type='text']").val('');$.ajax({method:'POST',url:'/comments/',data:{csrfmiddlewaretoken:$('[name="csrfmiddlewaretoken"]').val(),text:toadd,genoid:genodiv.find("div.detailBox").attr('genoid')}}).done(function(data,text_status,jq_xhr){jq_data=$(data);if(jq_data.filter('title').length){window.location=window.location.href.replace(window.location.pathname,'');return;}
genodiv.find("div.comments").html(data);genodiv.find("span.countcomments").html((data.match(/<li>/g)||[]).length);return;}).fail(function(data){alert('Failed to add/get comment: commentfail001');return;});};function setup_handlers(){$('.favorite').click(function(){toggle_fav(this);t=this;$.ajax({method:'POST',url:'/async/',data:{csrfmiddlewaretoken:$('[name="csrfmiddlewaretoken"]').val(),cc:this.getAttribute('cc'),id:this.getAttribute('genoid')}}).done(function(data,text_status,jq_xhr){if(data!='ok'){toggle_fav(t);alert('Failed to set favourite: errfav001');return;}}).fail(function(data){toggle_fav(t);alert('Failed to set favourite: errfav002');return;});});$('.favorite').mouseover(function(){if(!this.hasAttribute('active')){this.setAttribute('hover','');}});$('.favorite').mouseout(function(){this.removeAttribute('hover');});$('.crefresh').click(function(){get_or_add_comments(this);});$('.hashtag').click(function(){temp=$(this).closest("div.list-group").find("input[type='text']").val();if(temp.indexOf(this.text)==-1){$(this).closest("div.list-group").find("input[type='text']").val(temp+' '+this.text);}});$(".show-more").click(function(){var $this=$(this);var content=$this.closest("div.ggrp").find("div.content");content.switchClass("hideContent","showContent",400);$this.addClass("hidden");ga('send','event','browse','expand','',0);});}
function nux_tour(){var geno_id=null;var score=null;var frequency=null;var geno_doc=$("#first_geno");if(geno_doc){var geno_id_elems=geno_doc.find("#geno-id");if(geno_id_elems){geno_id=geno_id_elems[0];var span_elems=geno_doc.find(".label");score=(span_elems)?span_elems[0]:null;frequency=(span_elems&&span_elems.length>1)?span_elems[1]:null;}}
var html_template="<div class='popover tour' role='tooltip'>"+"<div class='arrow'></div>"+"<div class='popover-content'></div>"+"<div class='popover-navigation'>"+"<div class='btn-group'>"+"<button class='btn btn-sm btn-default' data-role='prev'>&laquo; Prev</button>"+"<button class='btn btn-sm btn-default' data-role='next'>Next &raquo;</button>"+"</div>"+"<button class='btn btn-sm btn-default' data-role='end'>End tour</button>"+"</div>"+"</div>";var tour=new Tour({name:"nux_tour",storage:window.localStorage,template:html_template,autoscroll:true,keyboard:true,steps:[]});tour.addStep({element:"#first_geno",backdrop:"true",backdropPadding:false,placement:"bottom",content:"You are exploring the <b>full report (with infinite scroll)</b> sorted by predicted impact. <b>Highlighted here is the basic unit of information</b> - a genotype or a genoset that matched your genome.",});if(geno_id){tour.addStep({element:geno_id,container:"body",placement:"bottom",content:"This is the id of the geno-document (<b>"+geno_id.outerHTML+"</b>). The geno-document can be either a genotype - a DNA sequence determining a specific characteristic - or a genoset - a defined set of genotypes."});}
if(score){tour.addStep({element:score,placement:"bottom",content:"Perceived impact score: how much this is likely to impact you (from 0 to 10, with anything above 3 likely to have a noticeable impact).<br> This badge also indicates the repute of the geno document - good, bad, warning or info ("+score.outerHTML+"). This is a machine learned score."});}
if(frequency){tour.addStep({element:frequency,placement:"bottom",content:"The frequency of this genotype in the overall population ("+frequency.outerHTML+"). Rare genotypes are more likely to offer valuable information."});}
tour.addSteps([{element:"#first_geno .favorite",placement:"bottom",content:"Bookmark your favorite geno-documents for future reference and to receive updates when new information is available."},{element:"#first_geno .detailBox",placement:"top",content:"See anonymous comments from other users for this genotype/genoset",onShow:function(tour){var content=$('#first_geno .show-more .btn');if(content){content.click();}}},{element:"#nux-searchbar",placement:"bottom",content:"Search for a term, gene, SNP or any geno-document. <br><br>This is a great way to explore your data, <i>e.g. how might aspirin impact you?</i> Try searching for aspirin!"},{element:"#nux-filters",placement:"bottom",content:"Filter results by geno-document frequency, repute or by topic of interest."},{element:"#nux-favorites",placement:"bottom",content:"Here you can find all your previously bookmarked geno-documents.",onShow:function(tour){var toggle_navbar_btn=$(".navbar-header .navbar-toggle");if(toggle_navbar_btn&&toggle_navbar_btn.length>0){toggle_navbar_btn[0].click();}}},{element:"#nux-topics",placement:"bottom",content:"All geno-documents grouped by pre-defined topics, like metabolism or psychological, are available here."},{element:"#nux-summary",placement:"bottom",content:"The dashboard contains your top10 important genotypes and topics"},]);tour.init();tour.start();}
...
return(false);}
$(document).on('change','.btn-file :file',function(){var input=$(this),numFiles=input.get(0).files?input.get(0).files.length:1,label=input.val().replace(/\\/g,'/').replace(/.*\//,'');input.trigger('fileselect',[numFiles,label]);});$(document).ready(function(){$('.btn-file :file').on('fileselect',function(event,numFiles,label){var input=$(this).parents('.input-group').find(':text'),log=numFiles>1?numFiles+' files selected':label;if(input.length){input.val(log);}else{if(log)alert(log);}});});var polling_timeout=100;var max_retries_polling_genome_ready=60*1000/polling_timeout;function on_query_fail(message){$('div#status_text').text(message);$('div#processing_genome').addClass('hidden');$('div#status_div').removeClass('hidden');}
function query_genome_ready(){setTimeout(function(){$.ajax({method:'POST',url:'/processing_genome/',data:{csrfmiddlewaretoken:$('[name="csrfmiddlewaretoken"]').val(),opid:$('div#processing_genome').attr('opid')},}).done(function(data,text_status,jq_xhr){$('div#processing_result').html(data);var user_type=$('div#redirect_to_search').attr('utype');var status=$('div#status_msg').attr('msg');if(user_type){window.location.replace(window.location.origin+'/search/?type='+user_type);}else if(status){on_query_fail(status);}else if(max_retries_polling_genome_ready>0){max_retries_polling_genome_ready--;query_genome_ready();}else{on_query_fail('Processing the genome is taking too long, please try again later.');}
return;}).fail(function(jq_xhr,text_status,errorThrown){on_query_fail('Something went wrong while processing the genome, please try again later.');return;});},polling_timeout);}
$(document).ready(function(){if($(this).find('div#processing_genome').length){query_genome_ready();}});;var bind=function(fn,me){return function(){return fn.apply(me,arguments);};};(function(window,factory){if(typeof define==='function'&&define.amd){return define(['jquery'],function(jQuery){return window.Tour=factory(jQuery);});}else if(typeof exports==='object'){return module.exports=factory(require('jquery'));}else{return window.Tour=factory(window.jQuery);}})(window,function($){var Tour,document;document=window.document;Tour=(function(){function Tour(options){this._showPopoverAndOverlay=bind(this._showPopoverAndOverlay,this);var storage;try{storage=window.localStorage;}catch(error){storage=false;}
